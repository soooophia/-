...
#
# #数据读取
# train=pd.read_csv('dataM/meinian_round1_train_20180408.csv',sep=',',encoding='gbk')
# test=pd.read_csv('dataM/meinian_round1_test_20180409.csv',sep=',',encoding='gbk')
# data_part1=pd.read_csv('dataM/meinian_round1_data_part1_20180408.txt',sep='$',encoding='utf-8')
# data_part2=pd.read_csv('dataM/meinian_round1_data_part2_20180408.txt',sep='$',encoding='utf-8')
#
...
#     data = data[data['field_results'] != '-']
#     data = data[data['field_results'] != '无']
#     return data
#
...
# merge_part1_2 = part1_2.pivot(index='vid',values='field_results',columns='table_id')
# print('--------------新的part1_2组合完毕----------')
